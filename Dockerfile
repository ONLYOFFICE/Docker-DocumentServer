...
RUN    wget -q -P /tmp "https://github.com/thomisus/server/releases/download/7.2.1.1/onlyoffice-documentserver_7.2.1-1.oou_amd64.deb" && \
    apt-get -y update && \
    service postgresql start && \
    apt-get -yq install /tmp/onlyoffice-documentserver_7.2.1-1.oou_amd64.deb && \
    service postgresql stop && \
    service supervisor stop && \
    chmod 755 /app/ds/*.sh && \
    rm -f /tmp/onlyoffice-documentserver_7.2.1-1.oou_amd64.deb && \
