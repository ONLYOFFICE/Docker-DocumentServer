...
- **SECURE_LINK_SECRET**: Defines the nginx config [secure_link_md5](http://nginx.org/ru/docs/http/ngx_http_secure_link_module.html#secure_link_md5) directive. Defaults to `random string`.
